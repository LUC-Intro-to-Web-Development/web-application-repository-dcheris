...
const betaUrl = "https://beta-api.crunchyroll.com/"
...
export default class API {
    ...
    public static session = async () => {
        ...
        const response = await API.getNoAuth("start_session", {access_token: "LNDJgOit5yaRIWN", device_type: "com.crunchyroll.windows.desktop", device_id: uuid.v4()}).then((r) => r.data)
